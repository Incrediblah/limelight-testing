...
public class autoPositionArmDown extends SequentialCommandGroup {
  /** Creates a new autoPositionArmDown. */
  public autoPositionArmDown(ArmSubsystem arm, ElevatorSubsystem elevator, double armSetPoint, double elevatorSetPoint ) {
